 ...
 void ChangeTouchKeyvalue(void)
{
     ...
     {
         case 0x00100000:exKeyValue = 1;
         break;
         case 0x00200000:exKeyValue = 2;
         break;
         case 0x00400000:exKeyValue = 3;
         break;
         case 0x00800000:exKeyValue = 4;
         break;
         case 0x01000000:exKeyValue = 5;
         break;
         case 0x02000000:exKeyValue = 6;
         break;
