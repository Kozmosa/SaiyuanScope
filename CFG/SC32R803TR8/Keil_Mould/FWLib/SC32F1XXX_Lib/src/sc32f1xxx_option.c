...
/**
  * @brief  Enables or disables the WDT peripheral.The IFB(AHB_CFG->IFBEN) must be enabled first before the WDT enable can be configured.
...
/**
 * @brief  Configures the LVR voltage gear.The IFB(AHB_CFG->IFBEN) must be enabled first before the WDT enable can be configured.
...
/**
 * @brief  Enables or disables the JTAG function.The IFB(AHB_CFG->IFBEN) must be enabled first before the WDT enable can be configured.
 * @param  NewState[in]: new state of the ADCx peripheral.
 *                  - DISABLE:Function disable
 *                  - ENABLE:Function enable
 * @retval None
...
/**
 * @brief  IAP protection locale A.The IFB(AHB_CFG->IFBEN) must be enabled first before the WDT enable can be configured.
...
/**
 * @brief IAP protection locale B.The IFB(AHB_CFG->IFBEN) must be enabled first before the WDT enable can be configured.
