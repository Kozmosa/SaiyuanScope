...
#define __NVIC_PRIO_BITS          2U /*!< SC32R601 uses 2 Bits for the Priority Levels 			*/
...
#define HIRC_VALUE    ((uint32_t)72000000) /*!< Value of the Internal oscillator in Hz*/
#endif /* HIRC_VALUE */
...
typedef struct
{
    ...
    __IO uint32_t CAN_TTSL;          /*!< CAN TimestampLow Timer register, Address offset: 0xD0 */  /*V0.3    */
...
typedef struct
{
    ...
    __IO uint32_t CAN_TIML;          /*!< CAN TimestampLow Timer register, Address offset: 0xD0 */  /*V0.3    */
    __IO uint32_t CAN_TIMH;          /*!< CAN TimestampHigh Timer register,    Address offset: 0xD4 */   /*V0.3    */
} CAN_TypeDef;
