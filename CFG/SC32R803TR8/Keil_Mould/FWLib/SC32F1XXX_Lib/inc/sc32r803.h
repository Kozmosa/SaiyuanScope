...
#define HIRC_VALUE    ((uint32_t)64000000) /*!< Value of the Internal oscillator in Hz*/
#endif /* HIRC_VALUE */
...
#define __NVIC_PRIO_BITS          2U /*!< SC32R803 uses 2 Bits for the Priority Levels 			*/
...
/**
  * @brief SPI0/1 for APB0 ,Peripheral offset =0x40 SPI2/3 for APB1 ,Peripheral offset =0x40
  */
typedef struct
{
    ...
    __IO uint32_t SPIx_ADD;         /*!< Reserved, 									Address offset: 0x08 */
...
/**
  * @brief TWI0/1 for APB0 ,Peripheral offset =0x40 TWI2/3 for APB1 ,Peripheral offset =0x40
  */
typedef struct
{
...
typedef struct
{
	...
	__IO uint32_t QSPI_ADD;    /*!< TWI_QSPI0 Address register, 		      Address offset: 0x08 */
	__IO uint32_t QSPI_DATA;   /*!< TWI_QSPI0 Data register,   			Address offset: 0x0C */
	__IO uint32_t QSPI_IDE;    /*!< TWI_QSPI0 Interrupt /Dma Enable register,   Address offset: 0x10 */
	...
	__IO uint32_t QSPI_REV;    /*!< TWI_QSPI0 Resever register,   			Address offset: 0x1C */
} QSPI_TypeDef;
/**
...
typedef struct
{
	...
	__IO uint32_t CAN_RBUF[16];     		/*!< CAN Receive Buffer0 register,      Address offset: 0x08 */
...
typedef struct
{
	...
	__IO uint32_t CAN_TBUF[16];     		/*!< CAN Transmit Buffer0 register,    Address offset: 0x58 */
  __IO uint32_t CAN_TTSL;         /*!< CAN TimestampLow Timer register, Address offset: 0x98 */ 
  __IO uint32_t CAN_TTSH;         /*!< CAN TimestampHigh Timer register,    Address offset: 0x9C */  	
