...
typedef enum
{
    ...
    ADC_IT_EOCIE    = (uint16_t)ADC_IDE_EOCIE,	/*!< ADC sequence 0 sampling + conversion complete interrupt Flag */
    ADC_IT_EOSIE0   = (uint16_t)ADC_IDE_EOSIE0,	/*!< ADC sequence 0 sampling + conversion complete interrupt Flag */
