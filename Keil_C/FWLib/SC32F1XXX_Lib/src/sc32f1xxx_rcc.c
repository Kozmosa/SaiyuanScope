...
#endif
#if defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32R803)|| defined(SC32f15xx)||defined(SC32R601)
/**
 ...
 *                         SC32R803 Selection range(RCC_SYSCLKSource_HIRC,RCC_SYSCLKSource_LIRC,RCC_SYSCLKSource_HXT,RCC_SYSCLKSource_HIRC_2,RCC_SYSCLKSource_LXT)
...
ErrorStatus RCC_SYSCLKConfig ( RCC_SYSCLKSource_TypeDef RCC_SYSCLKSource )
{
    ...
    if ( RCC_SYSCLKSource != ( ( uint16_t ) ( ~RCC_CFG0_SYSCLKSW ) ) )
    {
        ...
        if ( ( RCC->RCC_CFG0 & RCC_CFG0_SYSCLKSW ) != RESET )
				{
#if defined(SC32R803)||defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806)||defined(SC32f15xx)||defined(SC32R601)
...
#elif defined (SC32R803) || defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806) || defined (SC32f15xx)||defined(SC32R601)
...
void RCC_GetClocksFreq ( RCC_ClocksTypeDef* RCC_Clocks )
{
    ...
    if ( ( RCC->RCC_CFG0 & RCC_CFG0_SYSCLKSW ) == RESET )
    {
#if defined(SC32f10xx) || defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32R803) || defined(SC32f15xx)|| defined(SC32R601)
...
#endif
#if defined (SC32R803)|| defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806)|| defined(SC32f10xx)
/**
...
/**
  ...
  * @param  RCC_AHBPeriph[in]: specifies the AHB1 peripheral to gates its clock.
	...
	*                 SC32R803 Selection range(RCC_AHBPeriph_DMA,RCC_AHBPeriph_CRC,RCC_AHBPeriph_IFB,RCC_AHBPeriph_CAN,RCC_AHBPeriph_ALL)
...
/**
  ...
  * @param  RCC_APB0Periph[in]: specifies the APB01 peripheral to gates its clock.
	...
	*                 SC32R803 Selection range(RCC_APB0Periph_TIM0-RCC_APB0Periph_TIM3,RCC_APB0Periph_QTWI0,RCC_APB0Periph_QTWI2,RCC_APB0Periph_UART0,RCC_APB0Periph_UART5,RCC_APB0Periph_UART1,RCC_APB0Periph_PWM0,RCC_APB0Periph_ALL)
...
/**
  ...
  *             SC32R803 Selection range(RCC_APB1Periph_TIM4-RCC_APB1Periph_TIM7,RCC_APB1Periph_QTWI1,QTWI2,RCC_APB1Periph_UART2,RCC_APB1Periph_UART4,RCC_APB1Periph_ALL)
...
/**
  ...
  *             SC32R803 Selection range(RCC_APB2Periph_LEDPWM,RCC_APB2Periph_LCD_LED,RCC_APB2Periph_UART3,RCC_APB2Periph_ALL)
 ...
 * @brief  Forces or releases APB1 peripheral reset.
  * @param  RCC_APB1Periph[in]: specifies the APB1 peripheral to gates its clock.
  *             SC32f10xx Selection range(RCC_APB1Periph_TIM4-RCC_APB1Periph_TIM7,RCC_APB1Periph_TWI1,RCC_APB1Periph_UART2,RCC_APB1Periph_ALL)
  *             SC32R803 Selection range(RCC_APB1Periph_TIM4-RCC_APB1Periph_TIM7,RCC_APB1Periph_QTWI1,RCC_APB1Periph_QTWI2,RCC_APB1Periph_UART2,RCC_APB1Periph_UART4,RCC_APB1Periph_ALL)
  *             SC32f12xx Selection range(RCC_APB1Periph_TIM4-RCC_APB1Periph_TIM7,RCC_APB1Periph_TWI1,RCC_APB1Periph_SPI2,RCC_APB1Periph_UART2,RCC_APB1Periph_UART4,RCC_APB1Periph_ALL)
  *             SC32f15xx Selection range(RCC_APB1Periph_TIM2-RCC_APB1Periph_TIM3,RCC_APB1Periph_TWI1,RCC_APB1Periph_UART2,RCC_APB1Periph_ALL)
  *             - RCC_APB1Periph_TIM2:Select peripheral TIM2
  *             - RCC_APB1Periph_TIM3:Select peripheral TIM3 
 ...
 * @param  RCC_APB2Periph[in]: specifies the APB2 peripheral to reset its clock.
  ...
  *             SC32R803 Selection range(RCC_NMIPeriph_CSS,RCC_NMIPeriph_CMP,RCC_NMIPeriph_INT0,RCC_NMIPeriph_ALL,RCC_NMIPeriph_SRAMPE)
 ...
 *                         SC32R803  Selection range(RCC_FLAG_CLKIF,RCC_FLAG_SRAMPEIF)
 *                         SC32f12xx Selection range(RCC_FLAG_CLKIF,RCC_FLAG_SRAMPEIF)
 *                         SC32f15xx Selection range(RCC_FLAG_SRAMPEIF)
...
/**
  * @brief  This function provides millisecond-level delay.
	*               1. When using this function, it is necessary to call the "SC_IncTick" function within
	*  				   the "SysTick_IRQHandler" in the SC_it.c file. The tick timer triggers interrupts 
	*				   at intervals of 1 millisecond.
	* 				2. After modifying the clock frequency of the tick timer, please note that the count value 
	* 				   also needs to be adjusted, which is equal to the clock frequency divided by 1000.
...
/**
  * @brief  This function provides microsecond-level delay.
	*               1. When using this function, it is necessary to call the "SC_IncTick" function within
	*  				   the "SysTick_IRQHandler" in the SC_it.c file. For delays exceeding 10 microseconds, 
	*				   the tick timer interrupt is triggered only once. 
	* 				2. When the clock frequency of the SysTick timer is 1MHz, the value of Delay should be
	* 				   less than 0xFFFFFF.Theoretically, the maximum delay achievable is 16777215 microseconds. 
	* 				   If the clock frequency of the SysTick timer is changed to another frequency, the maximum 
	* 				   value of Delay will vary accordingly.
	* 				3. After modifying the clock frequency of the tick timer, please note that the count value 
	* 				   also needs to be adjusted, which is equal to the clock frequency divided by 1000.
  * @param  us_Delay[in]: Specifies the length of delay time, in microseconds.(us)
	*                     -Value: >=10(Integers)
  * @param  Sys_freq[in]: Tick timer's clock frequency,which can be obtained from the SYSTICK Configuration in EasyCodeCube.
  * @retval None
  */
