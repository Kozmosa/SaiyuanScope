...
typedef enum
{
  ...
  SPI_DataSize_24B  = (uint32_t)(0X02U << TWI_QSPIx_CON_DWIDTH_Pos),  /*!< SPI Data Size:Set data frame format to 8bit    */
  SPI_DataSize_32B = (uint32_t)(0X03U << TWI_QSPIx_CON_DWIDTH_Pos),  /*!< SPI Data Size:Set data frame format to 16bit   */
} SPI_DataSize_TypeDef;
