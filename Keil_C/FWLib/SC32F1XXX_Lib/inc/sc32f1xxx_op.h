...
typedef enum
{
    OP_PGAGain_NonInvert8_Invert7 = ( uint16_t ) ( 0x00U << OP_CON_PGAGAIN_Pos ), /*!< The OP inverting input gain is 8/7 times  */
    OP_PGAGain_NonInvert16_Invert15 = ( uint16_t ) ( 0x01U << OP_CON_PGAGAIN_Pos ), /*!< The OP inverting input gain is 16/15 times   */
    OP_PGAGain_NonInvert32_Invert31 =  ( uint16_t ) ( 0x02U << OP_CON_PGAGAIN_Pos ), /*!< The OP in-phase input gain is 32/31 times  */
    OP_PGAGain_NonInvert64_Invert63 = ( uint16_t ) ( 0x03U << OP_CON_PGAGAIN_Pos ), /*!< The OP in-phase input gain is 64/63 times  */
...
typedef enum
{
  	OP_PGAGain_NonInvert4_Invert3 = ( uint16_t ) ( 0x00U << OP_CON_PGAGAIN_Pos ), /*!< The OP in-phase input gain is 64/63 times  */
	  OP_PGAGain_NonInvert8_Invert7 = ( uint16_t ) ( 0x01U << OP_CON_PGAGAIN_Pos ), /*!< The OP inverting input gain is 8/7 times  */
    OP_PGAGain_NonInvert16_Invert15 = ( uint16_t ) ( 0x02U << OP_CON_PGAGAIN_Pos ), /*!< The OP inverting input gain is 16/15 times   */
    OP_PGAGain_NonInvert32_Invert31 =  ( uint16_t ) ( 0x03U << OP_CON_PGAGAIN_Pos ), /*!< The OP in-phase input gain is 32/31 times  */
} OP_PGAGain_TypeDef;
