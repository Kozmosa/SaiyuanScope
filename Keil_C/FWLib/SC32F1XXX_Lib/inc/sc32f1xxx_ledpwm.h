...
typedef struct
{
    ...
    uint32_t LEDPWM_OutputChannel1; /*!< Specifies the output Channel.
																			 This parameter can be a value of @ref LEDPWM_Channel_Typedef */

    uint32_t LEDPWM_LowPolarityChannl0; /*!< Specifies the low polarity Channel.
																				 This parameter can be a value of @ref LEDPWM_Channel_Typedef */

    uint32_t LEDPWM_LowPolarityChannl1; /*!< Specifies the low polarity Channel.
																				 This parameter can be a value of @ref LEDPWM_Channel_Typedef */
#endif
} LEDPWM_InitTypeDef;
/**
