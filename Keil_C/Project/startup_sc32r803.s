...
__Vectors       DCD     __initial_sp                   ; Top of Stack
				...
				DCD		RCC_IRQHandler				   ; RCC£º£ºVibration stop detection
				DCD		0                              ; LDP
...
Reset_Handler    PROC
        ...
        IMPORT  SystemInit  
				 ...
				 LDR 	 R2,=0x00000001
				 ORRS 	 R1,R1,R2
				 STR 	 R1,[R0]              ;AHB_CFG  Enable the DMA clock
				 ...
				 LDR 	 R2,=0xFFFFFFFE
				 ANDS 	 R1,R1,R2
				 STR 	 R1,[R0]              ;AHB_CFG  Disable the DMA clock
				 ...
				 LDR	 R0,=0x40021000
				 LDR     R1,=0x00800020
				 STR     R1,[R0]              ;APB1_CFG  Enable APB1 and SPI1_TWI1 clocks
				 ...
				 LDR	 R0,=0x40021000
				 LDR     R1,=0x00000000
				 STR     R1,[R0]              ;APB1_CFG Disable the APB1 clock	
				 
				 LDR	 R0,=0x40022000
				 LDR     R1,=0x00800040
				 STR     R1,[R0]              ;APB2_CFG  Enable APB2 and ADC clocks				 
				 ...
				 LDR	 R0,=0x40022000
				 LDR     R1,=0x00000000
				 STR     R1,[R0]              ;APB2_CFG  Disable the APB2 clock	
